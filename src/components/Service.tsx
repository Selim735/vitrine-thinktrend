  ...
  const services = [
    {
        ...
        icon: <img src='/icons/Frame-dev.svg' alt='web development' className='w-10 h-10' />,
      },
    {
      title: "Marketing Digital",
      description:
        "Gestion des réseaux sociaux. Campagnes publicitaires ciblées. Optimisation SEO pour améliorer votre classement dans les moteurs de recherche.",
        icon: <img src='/icons/marketing.svg' alt='web development' className='w-10 h-10' />,
    },
    {
      ...
      description:
        ...
        icon: <img src='/icons/desg.svg' alt='web development' className='w-10 h-10' />,
    },
    {
      title: "Formations sur Mesure",
      description: "Sessions pratiques pour maîtriser les compétences en marketing digital et développement web.",
      icon: <img src='/icons/formation.svg' alt='web development' className='w-10 h-10' />,
    },
  ]
