...
function TimelineStep({ step, index }: { step: Step; index: number }) {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={`relative overflow-hidden rounded-xl shadow-lg transform transition-transform duration-500 hover:scale-[1.02] ${
      ...
      >
        <div
          className={`bg-white p-6 md:p-8 rounded-xl shadow-lg border-t-4 border-[#1D1046] ${
